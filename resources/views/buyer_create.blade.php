...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/buyer/bcreate.css') }}" >
...
<body>
    ...
    <div class="conten-control">
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('buyer.store') }}" class="create-position">
                @csrf
                @method('post')
                    <div class="buyer-number">
                        <div class="buyer-style">
                            <label for="exampleInputEmail">Nama Buyer</label><br>
                            <input class="buyer-style-input" type="text" placeholder="Input Nama" name="buyer_name">
                        </div>
                        <div class="number-style">
                            <label for="exampleInputEmail">Plat Number</label><br>
                            <input class="number-style-input" type="text" placeholder="Input Nomer" name="plat_number">
                        </div>
                    ...
                    <div class="type">
                        ...
                        <select name="car_id" class="form-control scroll-select" size="10">
